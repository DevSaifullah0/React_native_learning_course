...
const Patch_API = () => {
    ...
    const handleUpdate= async()=>{
        try {
            const response= await axios.patch(`http://192.168.1.5:3000/users/${Update.id}`,{
                ...Update.name && {name:Update.name},
                ...Update.age && {name:Update.age},
                ...Update.email && {name:Update.email},
  ...
  return (
    <View style={styles.Container}>
      <Text style={styles.HeaderText}>Patch_API Method</Text>
